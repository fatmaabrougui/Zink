...
<div id="special-offser" class="parallax pricing">
        <div class="container inner">
            ...
            <h2 class="section-title text-center">Produits</h2>
    ...
    <button class="btn btn-danger" onclick="addToCard(<?php echo "$f->id,$f->price,'$f->name','$f->image'"; ?>)" >Commander</button>
                      
                        </div>
                        <!--price tag-->
                        <span class="hot-tag br-red" style="font-size:14px;"><?php echo $f->price; ?>TND</span>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button  class="btn btn-success" onclick="saveToCard()" >Ajouter au panier</button>
