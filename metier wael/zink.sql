...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  sam. 07 déc. 2019 à 23:34
...
INSERT INTO `client` (`id_client`, `nom_client`, `email_client`, `tel_client`, `password_client`) VALUES
(40, 'abc', 'bcd', 55446666, 123123),
(41, 'abc', 'a', 225544, 1),
(42, 'aaa', 'aa', 5544, 12);
...
ALTER TABLE `wishlist`
  ADD CONSTRAINT `wishlist_ibfk_1` FOREIGN KEY (`id_p`) REFERENCES `produit` (`id_p`);
COMMIT;
